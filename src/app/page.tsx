    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex flex-1">
        <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col px-6 py-10 pt-0">
          <section className="flex flex-1 flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="flex max-w-2xl flex-col gap-4">
              ...
              <div className="space-y-4">
                <h1 className="text-4xl leading-tight font-bold tracking-tight text-foreground">
                  Bem-vindo à{" "}
                  <span className="text-primary">Luminar Educa...</span>
                </h1>

                <p className="max-w-xl text-base leading-7 text-muted-foreground">
                  Uma plataforma feita para conectar professores recém-formados
                  de alunos que buscam ensino de qualidade, com mais
                  praticidade, visibilidade e oportunidade.
                </p>
              </div>

              <div className="grid gap-3 sm:grid-cols-2">
                <Card className="border-primary/10 shadow-sm">
                  <CardContent className="flex items-start gap-3 p-4 py-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Valorize profissionais em início de carreira com espaço
                        para crescer.
                      </p>
                    </div>
                  </CardContent>
                ...
                <Card className="shadow-sm">
                  <CardContent className="flex items-start gap-3 p-4 py-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Encontre apoio educacional com mais proximidade e
                        confiança.
                      </p>
                    </div>
                  </CardContent>
                ...
                <Card className="shadow-sm">
                  <CardContent className="flex items-start gap-3 p-4 py-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Aproximamos alunos, famílias e educadores em um só
                        lugar.
                      </p>
                    </div>
                  </CardContent>
