              ...
              <Dialog>
                ...
                <DialogContent className="sm:max-w-md">
                  <DialogHeader className="mb-2 text-left">
                    ...
                    <DialogDescription>
                      Selecione como deseja ingressar na plataforma Luminar Indica.
                    </DialogDescription>
                  </DialogHeader>
                  ...
                  <div className="grid grid-cols-2 gap-4 pb-4">
                    <Link
                      ...
                      className="flex flex-col items-center gap-3 rounded-xl border border-border p-6 transition-colors hover:border-primary hover:bg-primary/5 cursor-pointer"
                    >
